...
public class BoardInsert extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==b1) {
			...
			//dao.boardInsert(nameTf.getText(), subTf.getText(), ta.getText(), pwdPf.getSelectedText());
			System.out.println(nameTf.getText()+" "+subTf.getText()+" "+ta.getText()+" "+pwdPf.getSelectedText());
		}
